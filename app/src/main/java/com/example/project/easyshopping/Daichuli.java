...
import com.example.project.easyshopping.Adapter.DclAdapter;
 ...
 */
public class Daichuli extends Fragment {
    private View mMainView;
    private static ArrayList<Ord> sgl = new ArrayList<Ord>();

    private ListView listView3;
    public static DclAdapter mDclAdapter;
    ...
    List<Map<String, Object>> DclList = new ArrayList<Map<String, Object>>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainView = inflater.inflate(R.layout.daichuli, container, false);
        Log.e("DCL的onCreateView", "成功了！");
        ...
        Log.e("Daichuli的onStart", "ShopNme是" + ShopName);
        download(ShopName);
    ...
    private void download(String s) {
        ...
        query.findObjects(getActivity(), new FindListener<Ord>() {
            ...
            public void onSuccess(List<Ord> list) {
                Toast.makeText(getActivity(), "成功查询" + list.size() + "条待处理订单。", Toast.LENGTH_SHORT).show();
                sgl = (ArrayList<Ord>) list;
                listView3 = (ListView) mMainView.findViewById(R.id.listView3);
                DclList = getListItems(sgl);
                mDclAdapter = new DclAdapter(getActivity(), DclList); //创建适配器
                mDclAdapter.notifyDataSetChanged();
                listView3.setAdapter(mDclAdapter);
            }
