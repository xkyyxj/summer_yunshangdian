 ...
 */
public class DclDetail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dcl_detail);
    ...
    private void initButton() {
        ...
        if (mOrd.getJystate().equals(MyOrders.DCL_2)) {
            send.setText("配送中~");
            ...
            send.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Ord o = new Ord();
                    o.setJystate(MyOrders.DCL_2);
                    Log.e("Dcl的initButton()", "id:" + id);
                    o.update(v.getContext(), id, new UpdateListener() {
                        @Override
                        public void onSuccess() {
                            AlertDialog.Builder dialog_1 = new AlertDialog.Builder(DclDetail.this);
                            dialog_1.setTitle("提示");//设置标题
                            dialog_1.setMessage("开始配送！");//设置内容
                            ...
                            dialog_1.show();
                            Daichuli.mDclAdapter.notifyDataSetChanged();

                        }

                        @Override
                        public void onFailure(int i, String s) {
                            AlertDialog.Builder dialog_2 = new AlertDialog.Builder(DclDetail.this);
                            dialog_2.setTitle("提示");//设置标题
                            dialog_2.setMessage("点击失败，请重试！");//设置内容
